let app,debug0,http,fs,path;_25f‍.w("../app",[["default",["app"],function(v){app=v}]]);_25f‍.w("debug",[["default",["debug0"],function(v){debug0=v}]]);_25f‍.w("http",[["default",["http"],function(v){http=v}]]);_25f‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_25f‍.w("path",[["default",["path"],function(v){path=v}]]);
...
function onError(error) {
  ...
  switch (error.code) {
    case 'EACCES':
      _25f‍.g.console.error(bind + ' requires elevated privileges');
      process.exit(1);
      break;
    case 'EADDRINUSE':
      _25f‍.g.console.error(bind + ' is already in use');
      process.exit(1);
      break;
    default:
      throw error;
